    ...
    <section className="relative w-full pt-32 pb-16 px-4 sm:px-6 text-center overflow-hidden">
      <div className="max-w-[1100px] mx-auto flex flex-col items-center">
        ...
        <div className="fade-in relative mb-16" style={{ animationDelay: "0.5s" }}>
          ...
          <Link
            href="/decide"
            className="relative w-[120px] h-[120px] rounded-full bg-gradient-to-br from-[#4f46e5] to-[#7c3aed] flex flex-col items-center justify-center text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer"
          >
